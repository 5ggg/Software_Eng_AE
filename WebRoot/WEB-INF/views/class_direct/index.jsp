...
<dd style="display: block;"> 
 ...
 <li>
  ...
  <a   href="javascript:void(0)" data-href="${pageContext.request.contextPath}/class_direct/teaching_requirement" data-title="教学需求" title="教学需求"> 
教学需求 
</a>
...
<dd style="display: block;"> 
 ...
 <li>
  ...
  <a   href="javascript:void(0)" data-href="${pageContext.request.contextPath}/class_direct/match_info" data-title="已匹配的教学需求" title="已匹配的教学需求"> 
已匹配的教学需求 
</a>
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="教学需求" data-href="${pageContext.request.contextPath}/class_direct/teaching_requirement">教学需求</span>
					<em></em></li>
		</ul>
	</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" id="iframeDom" frameborder="0" src="${pageContext.request.contextPath}/class_direct/teaching_requirement"></iframe>
	</div>
</div>
</section>
