                                                ...
                                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/hui/static/h-ui/js/H-ui.min.js"></script>
                                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/hui/static/h-ui.admin/js/H-ui.admin.js"></script> <!--/_footer 作为公共模版分离出去-->
                                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/hui/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
                                                            ...
                                                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=9005"></script>
                                                                ...
                                                                function ajaxList(page) {
                                                                    ...
                                                                    showLoading('${pageContext.request.contextPath}/static/common/loading.gif');
                                                                        $.ajax({
                                                                            type : 'get',
                                                                            url : "${pageContext.request.contextPath}/ppt/teaching_request/queryList",
                                                                                data : {
                                                                                    "page":page,
                                                                                ...
                                                                                success : function(result) {
                                                                                    ...
                                                                                    for (var i = 0; i < rows.length; i++) {
                                                                                        ...
                                                                                        html+='<td>';
                                                                                        if(rows[i].teachingRequest.checkStatus=='1'){
                                                                                            html+='<a href="javascript:void(0)" onclick="updateByDefault(this)" data-id="'+rows[i].teachingRequest.id+'" act-type="1" class="btn btn-warning radius btnStyle">审核通过</a>';
                                                                                        }
                                                                                        if(rows[i].teachingRequest.checkStatus=='1'){
                                                                                            html+='<a href="javascript:void(0)" onclick="updateByDefault(this)" data-id="'+rows[i].teachingRequest.id+'" act-type="2" class="btn btn-danger radius btnStyle">审核不通过</a>';
                                                                                        }
                                                                                        html+='<a href="${pageContext.request.contextPath}/ppt/teaching_request/remark?id='+rows[i].teachingRequest.id+'" class="btn btn-primary  radius btnStyle">备注</a>';
                                                                                            html+='</td>';
                                                                                            html+='</tr>';
                                                                                        }
                                                                                        if (rows.length == 0) {
                                                                            ...
                                                                            function updateByDefault(e){
                                                                                ...
                                                                                if(r==true){
                                                                                    ...
                                                                                    $.ajax({
                                                                                        type : 'get',
                                                                                        url : "${pageContext.request.contextPath}/ppt/teaching_request/updateByDefault",
                                                                                            data : {
                                                                                                "id":id,
                                                                                                "type":type
                                                                                            },
