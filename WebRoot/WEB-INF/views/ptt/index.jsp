...
<dd style="display: block;"> 
 ...
 <li>
  ...
  <a   href="javascript:void(0)" data-href="${pageContext.request.contextPath}/ppt/teaching_request" data-title="教学请求管理" title="教学请求管理"> 
教学请求管理 
</a>
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="教学请求管理" data-href="${pageContext.request.contextPath}/ppt/teaching_request">教学请求管理</span>
					<em></em></li>
		</ul>
	</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" id="iframeDom" frameborder="0" src="${pageContext.request.contextPath}/ppt/teaching_request"></iframe>
	</div>
</div>
</section>
