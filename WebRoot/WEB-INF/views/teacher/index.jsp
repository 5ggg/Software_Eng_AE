...
<dd style="display: block;"> 
 ...
 <li>
  ...
  <a   href="javascript:void(0)" data-href="${pageContext.request.contextPath}/teacher/teaching_request" data-title="我的请求" title="我的请求"> 
我的请求 
</a>
...
<dd style="display: block;"> 
 ...
 <li>
  ...
  <a   href="javascript:void(0)" data-href="${pageContext.request.contextPath}/teacher/match_info" data-title="已匹配的教学任务" title="已匹配的教学任务"> 
已匹配的教学任务 
</a>
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="我的请求" data-href="${pageContext.request.contextPath}/teacher/teaching_request">我的请求</span>
					<em></em></li>
		</ul>
	</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" id="iframeDom" frameborder="0" src="${pageContext.request.contextPath}/teacher/teaching_request"></iframe>
	</div>
</div>
</section>
